function Box(anchor, cursor, angle, boundingBox, boxHelper, data) {
    ...
    this.object_id = 'stop_sign'; // object id (string)
    ...
    var Left = getCenter(topLeft.clone(), minVector.clone());
    var Top = getCenter(topLeft.clone(), maxVector.clone());
    var Right = getCenter(maxVector.clone(), bottomRight.clone());
    var Bottom = getCenter(minVector.clone(), bottomRight.clone());
    // height and centerZ
